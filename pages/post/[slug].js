...
import postPageInitialPropsTqYcResource from '../../resources/post-page-initial-props-tq_yc'
import postPageInitialPathsTqQXResource from '../../resources/post-page-initial-paths-tq_q-x'
          ...
          <div className="post-max-width1 max-content-container">
            <div className="post-top-part">
              ...
              <div className="post-navigate-container">
                <span className="post-text09">Info</span>
                <Link href="/about">
                ...
                <Link href="/restrictions">
                  <a className="post-link2">RESTRICTIONS</a>
                </Link>
                <Link href="/contact">
                  <a className="post-link3">CONTACT</a>
                </Link>
              </div>
              <div className="post-contact-container">
                <span className="post-text12">Contact Us</span>
                <a href="tel:+18885031722" className="post-link4">
                  (888) 503-1722
                </a>
                <a
                  href="mailto:service@ampureservices.com?subject=Site Service Request"
                  className="post-link5"
                >
                  SERVICE@AMPURESERVICES.COM
                </a>
              </div>
              <div className="post-subscribe-container">
                <span className="post-text13">Subscribe to our newsletter</span>
                <input
                  type="text"
                  id="newsletter"
...
export async function getStaticProps(context) {
  try {
    ...
    const response = await postPageInitialPropsTqYcResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
...
export async function getStaticPaths() {
  try {
    const response = await postPageInitialPathsTqQXResource({
      content_type: 'post',
      select: 'fields.slug',
    })
    return {
