...
import authorPageInitialPropsTq5sResource from '../../../resources/author-page-initial-props-tq_5s'
import authorPageInitialPathsTq1wResource from '../../../resources/author-page-initial-paths-tq_1w'
...
export async function getStaticProps(context) {
  try {
    const response = await authorPageInitialPropsTq5sResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await authorPageInitialPathsTq1wResource({
      content_type: 'author',
    })
