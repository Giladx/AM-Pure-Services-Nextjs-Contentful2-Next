...
import authorPageInitialPropsTqD6Resource from '../../../resources/author-page-initial-props-tq_d6'
import authorPageInitialPathsTqNSResource from '../../../resources/author-page-initial-paths-tq_n-s'
...
export async function getStaticProps(context) {
  try {
    const response = await authorPageInitialPropsTqD6Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await authorPageInitialPathsTqNSResource({
      content_type: 'author',
    })
