...
import authorPageInitialPropsTq9yResource from '../../../resources/author-page-initial-props-tq_9y'
import authorPageInitialPathsTqCjResource from '../../../resources/author-page-initial-paths-tq_cj'
...
export async function getStaticProps(context) {
  try {
    const response = await authorPageInitialPropsTq9yResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await authorPageInitialPathsTqCjResource({
      content_type: 'author',
    })
