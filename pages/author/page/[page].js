...
import authorPageInitialPropsTqBLResource from '../../../resources/author-page-initial-props-tq_b-l'
import authorPageInitialPathsTq3rResource from '../../../resources/author-page-initial-paths-tq_3r'
...
export async function getStaticProps(context) {
  try {
    const response = await authorPageInitialPropsTqBLResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await authorPageInitialPathsTq3rResource({
      content_type: 'author',
    })
