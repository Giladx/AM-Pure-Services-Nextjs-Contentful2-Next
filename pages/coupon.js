...
const Coupon = (props) => {
  return (
    <>
      <div className="coupon-container1">
        <Head>
          ...
          <meta
            property="og:title"
            content="Coupon - AM Pure Services | Airduct Cleaning | Drayer Vent Cleaning"
          />
          <meta
        ...
        <div className="coupon-container2">
          <div className="coupon-container3">
            <Script
              html={`
    <iframe
      id="JotFormIFrame-240843886917067"
      title="Claim Your 100% OFF"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allow="geolocation; microphone; camera; fullscreen"
      src="https://form.jotform.com/240843886917067"
      frameborder="0"
    ...
    var ifr = document.getElementById("JotFormIFrame-240843886917067");
    if (ifr) {
      var src = ifr.src;
      var iframeParams = [];
